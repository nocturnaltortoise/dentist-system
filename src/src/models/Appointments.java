...
//            stmt.executeUpdate(sql);
    ...
    public static void subscribe(Patient pat, HealthcarePlan plan){
    	int patientId = pat.getId();
    	String planName = plan.toString();
        ...
        try
        {
            ...
            sql = "UPDATE Patient SET PlanName = '" + planName + "' " +
    ...
    public static void unsubscribe(Patient pat){
    	int patientId = pat.getId();
        ...
        try
        {
            ...
            sql = "UPDATE Patient SET PlanName = null " +
            		"WHERE PatientID = " + patientId;
